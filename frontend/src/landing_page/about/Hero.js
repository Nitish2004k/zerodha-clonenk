...
function Hero() {
    return (
        <div className='container'>
            <div className='row p-5 mt-5 mb-5' style={{lineHeight:"1.8" , fontSize:"1.2em"}}>
                <h1 className='fs-2 text-center'>We pioneeredd the
                    discount broking nodel in india<br /> Now , be are breaking ground with  our technology.</h1>
            </div>

            <div className='row p-5 mt-5 border-top text-muted '>
                <div className='col-6 p-5 fs-6 texxt-muted'>
                    <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company Zerodha, a combination of Zero and "Rodha", the Sanskrit word for barrier.
                        ...
                        <p></p>Today, our disruptive pricing models and in-house technology have made us the biggest stock broker in India.</p>
